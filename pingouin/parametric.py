...
__all__ = ["gzscore", "test_normality", "multivariate_normality",
           "test_homoscedasticity", "test_dist", "epsilon", "test_sphericity",
           "ttest", "rm_anova", "rm_anova2", "anova", "anova2", "mixed_anova",
           "ancova", "ancovan"]
...
def multivariate_normality(X, alpha=.05):
    ...
    See Also
    --------
    test_normality : Test the univariate normality of one or more variables.
    test_homoscedasticity : Test equality of variance.
    test_sphericity : Mauchly's test for sphericity.
    ...
    to normality and is feasable for any dimension and any smaple size.

    Translated from the Matlab Robust Correlation toolbox.
    ...
    .. [2] Pernet, C. R., Wilcox, R. R., & Rousselet, G. A. (2013). Robust
       correlation analyses: false positive and power validation using a new
       open source Matlab toolbox. Frontiers in psychology, 3, 606.
